                    ...
                    return (
                        <div className='p-4 border border-gray-200 rounded-lg space-y-3' key={index}>
                            ...
                            <label>
                                ...
                                className='rounded border-gray-200 text-green-600 focus:ring-blue-500' />
                            ...
                            <div className='space-y-2'>
                                <div className='flex items-center justify-between'>
                                    ...
                                    <button className='items-center flex gap-1 px-2 py-1 text-xs bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors disabled:opacity-50'>
                                        <Sparkles className='w-3 h-3' /> Enhance with AI
                                    </button>
                                </div>

                                <textarea className='w-full text-sm px-3 py-2 rounded-lg resize-none' placeholder='Describe your key achievements and responsibilities...' rows={4} value={experience.description || ''} onChange={(e) => {updateExperience(index, 'description', e.target.value)}} />
                            </div>
                        </div>
                    )
                })}
