...
import { Zap, Sparkles, LayoutTemplate, UploadCloud } from 'lucide-react'
...
const features = [
  {
    ...
    description: 'Let Gemini AI enhance your professional summary and job descriptions to be ATS-friendly and impactful.'
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    title: 'PDF Import',
    description: 'Upload your existing resume as a PDF and AI will extract and structure all your data automatically.'
  },
  {
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    description: 'Choose from Modern, Classic, Minimal, and Minimal Image templates — each fully customizable with your accent color.'
  }
]
...
function Features() {
  return (
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
      ...
      <Title title="Build your Resume" description="Our streamlined process helps you create a professional, industry-ready resume in minutes." />

      <div className="flex flex-col md:flex-row xl:-ml-10 items-center justify-center">
        <img
        ...
        <div className="space-y-6 px-4 md:px-0">
          {features.map((f, i) => (
            <div key={i} className={`flex items-center justify-center rounded-xl py-4 pr-4 gap-6 max-w-md border ${f.bg}`}>
              <div className="p-6 aspect-square">{f.icon}</div>
              <div className="space-y-2">
                <h3 className="text-base font-semibold text-slate-700">{f.title}</h3>
