import { BriefcaseBusinessIcon, Globe, Linkedin, Mail, MapPin, Phone, User } from 'lucide-react'
                ...
                return (
                    <div className='space-y-1 mt-5' key={field.key}>
                        ...
                        <input
                            ...
                            className='mt-1 w-full px-3 py-2 border-gray-300 focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors text-sm'
